...
export default function PlayerRaiseModal({
  ...
  const sortedRaises = useMemo(() => {
    const next = [...raises];
    next.sort((a, b) => {
      const av = sortBy === "hand" ? a.handNumber : sortBy === "raiseTo" ? a.raiseTo : a.raiseOverPrevBet;
      const bv = sortBy === "hand" ? b.handNumber : sortBy === "raiseTo" ? b.raiseTo : b.raiseOverPrevBet;
